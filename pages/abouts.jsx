  ...
  return (
    <>
      ...
      <div className="bodyBox">
        <motion.div variants={titleVariant} initial="before" animate="after">
          ...
          <section className=" pb-4">
              ...
              <motion.div variants={leftSideVariant}>
                <div style={{ width: 300, display: "inline-block" }}>
                  ...
                  <div>
                    ...
                    looking for a job to work with talented people around the
                    world.
                  </div>
                </div>
              </motion.div>
            ...
            <article>
              ...
              >
                ...
                <div>
                  ...
                  Currently, I am postponing my journey and start learning by
                  myself cause of the covid and the various things happening in
                  Myanmar.
                </div>
              </motion.div>
            </article>
              ...
              <div>
                <motion.div variants={rightSideVariant} style={{ width: 350 }}>
                  ...
                  <div>
                    ...
                    motion. As in mobile development, I first learned about
                    Flutter. After working with flutter for about six months, I
                    tried React-Native. Both are amazing tools to create
                    cross-platform apps. Because of both React-Native and
                    Flutter&apos;s flexibility, both are frameworks that I am
                    happy to work with.
                  </div>
                </motion.div>
              </div>
            ...
            <article>
              <motion.div variants={leftSideVariant} style={{ width: 300 }}>
                ...
                <p>
                  I love creating clean and beautiful UI applications and
                  websites. I am willing to discuss newer technology with
                  different people. Leetcode questions are my kryptonite and I
                  use Vim in vs code. I love working with other developers and
                  UI designers, so feel free to connect with me to build amazing
                  stuff.
                </p>
              </motion.div>
            </article>
